...
router.post("/", function (req, res, next) {
  const { inst_name, subj_name, chap_name } = req.body
  ...
  connection.on("connect", function (err) {
    ...
    // sql
    var request = new Request("exec entryselector @institutename='"+inst_name+"',@subjectname='"+subj_name+"',@chaptername='"+chap_name+"'", function (
      err,
      rowCount,
      rows
    ) {
